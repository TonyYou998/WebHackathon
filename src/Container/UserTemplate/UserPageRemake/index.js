        ...
        <div className="container-fluid profile__wrapper">
                <div className="profile__header " style={{backgroundImage:"url(https://images.unsplash.com/photo-1508247967583-7d982ea01526?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2250&q=80)"}}>
                     <nav className=" profile__navbar navbar navbar-expand-lg navbar-dark">
                        ...
                        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                            ...
                            <a className="hover nav-item nav-link" href="#">Friends</a>
                            <a className="hover nav-item nav-link" href="#">Marks</a>
                            <a className="hover nav-item nav-link" href="#">More</a>
                ...
                <div className="d-flex">
                    ...
                    <div className="intro my-2 shadow  bg-white rounded">
                       <h4>Introdution</h4>
                       <ul>
                           <li style={{ color:"#16396a"}}> <span style={{color:"black"}}>Fullname </span>Tan Vuu </li>
                           <li style={{ color:"#16396a"}}> <span style={{color:"black"}}>Class </span>ATCL2019.1 </li>
                            <li style={{ color:"#16396a"}}> <span style={{color:"black"}}>ID </span>19520931 </li>
                            <li style={{ color:"#16396a"}}> <span style={{color:"black"}}>Academic Year </span>2021 </li>
                       </ul>
                    </div>
                    <div className="activities shadow  bg-white rounded">
                        <div className="activities__img">
                              <img src="https://scontent-xsp1-1.xx.fbcdn.net/v/t1.6435-9/159464480_1409520522720313_5253230999488202238_n.png?_nc_cat=108&ccb=1-3&_nc_sid=e3f864&_nc_ohc=p6tcczPBj48AX_O_u0g&_nc_ht=scontent-xsp1-1.xx&oh=7d6cf6d5e0612836bb557c3accabade3&oe=60A44CC8"  alt />

                        </div>
                      
                        <h6 style={{color:"#000 "}} className="py-4"> <span>currently activity:</span> Web hackathon</h6>
