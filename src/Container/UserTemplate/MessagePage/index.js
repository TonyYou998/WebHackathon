...
export function MessagePage(props) {
    ...
    return (
        <div className="message__wrapper  d-flex ">
                <div className="all__message shadow bg-white col-3 ">
                ...
                <div className="currend__message  col-9 ">
                        ...
                        <div className="type-text shadow-sm">
                            <spen> <input placeholder=""       
                                 type="text"/></spen><button className="btn btn-primary" style={{borderRadius:"40px"}}>Send</button>
